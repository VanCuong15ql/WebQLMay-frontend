...
const ActivityTable = ({ activities, handleDeleteActivity, handleAddActivity, handleUpdateActivity }) => {
  ...
  return (
    <div className="bg-white shadow-md rounded p-5 mb-5">
      <h2 className="text-lg font-bold mb-3">Theo dõi hoạt động máy thở</h2>
      <table className="table-auto w-full mb-4">
        <thead>
          <tr className="bg-gray-200">
            ...
            <th className="border px-4 py-2">Thời gian sử dụng (giờ)</th>
        ...
        <tbody>
          {activities.map(activity => (
            <tr key={activity._id} className="text-center">
              ...
              <td className="border px-4 py-2">{activity.soMay}</td>
      ...
      <div className="text-right font-bold mb-4">
        Tổng thời gian sử dụng: {totalUsageTime} giờ
      </div>
      ...
      {showActivityForm && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white p-5 rounded shadow-lg w-96">
            ...
            <input className="border p-2 m-1 w-full" type="text" name="soMay" placeholder="Số máy" value={newActivity.soMay} onChange={handleActivityChange} />
            ...
            <input className="border p-2 m-1 w-full" type="number" name="thoiGianSuDung" placeholder="Thời gian sử dụng (giờ)" value={newActivity.thoiGianSuDung} onChange={handleActivityChange} />
